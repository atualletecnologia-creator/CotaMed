...
function pegarPrimeiroValor(linha: Record<string, unknown>, chaves: string[]) {
  ...
  async function processarPlanilha(file: File | null) {
    try {
      ...
      if (!linhasNormalizadas.length) {
        setErro("Nenhum item válido encontrado. Use uma coluna de descrição como DESCRIÇÃO DOS PRODUTOS, DESCRICAO, PRODUTO ou OBJETO.");
        return;
      }
